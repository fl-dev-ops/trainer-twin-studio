...
from tools.whiteboard import build_whiteboard_tools
...
def build_interview_tools(*, room: Any, participant_identity: str) -> list[Any]:
    ...
    tools.extend(build_whiteboard_tools(room=room, participant_identity=participant_identity))
