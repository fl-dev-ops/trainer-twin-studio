...
function ActiveSession({
  ...
  // The runtime never publishes a "session-started" packet; the agent speaking
  // (or thinking) is the real signal that the interview has begun.
  const interviewReady = voiceAssistant.state !== "connecting";
