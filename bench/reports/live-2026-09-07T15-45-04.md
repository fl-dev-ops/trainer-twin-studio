...
- Timestamp: 2026-09-07T15:45:04.087Z

## Overall Metrics

| pipeline | Hit@1 | Hit@3 | Hit@5 | Hit@10 | P@10 | R@50 | MRR@10 | NDCG@10 | avg latency |
|---|---|---|---|---|---|---|---|---|---|
| hybrid (production) | 1.00 | 1.00 | 1.00 | 1.00 | 0.38 | 0.95 | 1.00 | 0.87 | 438ms |

## Per-Question Breakdown

| # | ID | Query Text | Hit@1 | Hit@5 | P@10 | R@50 | MRR@10 | First Match Rank | Latency |
|---|---|---|---|---|---|---|---|---|---|
| 1 | golden-01 | What is reconciliation in React and what are its high level phases? | 1 | 1 | 0.60 | 1.00 | 1.00 | #1 | 1035ms |
| 2 | golden-02 | Which algorithm is used for React tree comparison and what are its key assumptions? | 1 | 1 | 0.40 | 1.00 | 1.00 | #1 | 382ms |
| 3 | golden-03 | What are closures in JavaScript and what is a practical example of where they are used? | 1 | 1 | 0.40 | 1.00 | 1.00 | #1 | 359ms |
| 4 | golden-04 | How is JavaScript code executed, including execution context creation and execution phases? | 1 | 1 | 0.40 | 1.00 | 1.00 | #1 | 358ms |
| 5 | golden-05 | What is the difference between Just-In-Time (JIT) compilation and Ahead-Of-Time (AOT) compilation? | 1 | 1 | 0.30 | 1.00 | 1.00 | #1 | 361ms |
| 6 | golden-06 | What are higher-order components (HOC) in React and why are they used over simple utilities? | 1 | 1 | 0.70 | 1.00 | 1.00 | #1 | 387ms |
| 7 | golden-07 | If a three-second delay is given to setTimeout, will it definitely execute after 3 seconds, and why? | 1 | 1 | 0.30 | 1.00 | 1.00 | #1 | 374ms |
| 8 | golden-08 | What is the Temporal Dead Zone (TDZ) and how does hoisting work for let and const? | 1 | 1 | 0.20 | 1.00 | 1.00 | #1 | 361ms |
| 9 | golden-09 | Why did React need the Fiber architecture and what are the phases in Fiber? | 1 | 1 | 0.40 | 1.00 | 1.00 | #1 | 382ms |
| 10 | golden-10 | How do we prepare for a frontend machine coding round and what problems are asked? | 1 | 1 | 0.10 | 0.50 | 1.00 | #1 | 376ms |
